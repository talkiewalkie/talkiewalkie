...
type Event struct {
	...
	RecipientID        int         `db:"recipient_id" boil:"recipient_id" json:"recipient_id" toml:"recipient_id" yaml:"recipient_id"`
	MessageID          null.Int    `db:"message_id" boil:"message_id" json:"message_id,omitempty" toml:"message_id" yaml:"message_id,omitempty"`
	ConversationID     null.Int    `db:"conversation_id" boil:"conversation_id" json:"conversation_id,omitempty" toml:"conversation_id" yaml:"conversation_id,omitempty"`
	DeletedMessageUUID null.String `db:"deleted_message_uuid" boil:"deleted_message_uuid" json:"deleted_message_uuid,omitempty" toml:"deleted_message_uuid" yaml:"deleted_message_uuid,omitempty"`

	R *eventR `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L eventL  `db:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
var EventColumns = struct {
	...
	DeletedMessageUUID: "deleted_message_uuid",
}
...
var EventTableColumns = struct {
	...
	DeletedMessageUUID: "event.deleted_message_uuid",
}
...
var EventWhere = struct {
	...
	RecipientID        whereHelperint
	MessageID          whereHelpernull_Int
	ConversationID     whereHelpernull_Int
	DeletedMessageUUID whereHelpernull_String
}{
	ID:                 whereHelperint{field: "\"event\".\"id\""},
	UUID:               whereHelperuuid_UUID{field: "\"event\".\"uuid\""},
	CreatedAt:          whereHelpertime_Time{field: "\"event\".\"created_at\""},
	Type:               whereHelperstring{field: "\"event\".\"type\""},
	RecipientID:        whereHelperint{field: "\"event\".\"recipient_id\""},
	MessageID:          whereHelpernull_Int{field: "\"event\".\"message_id\""},
	ConversationID:     whereHelpernull_Int{field: "\"event\".\"conversation_id\""},
	DeletedMessageUUID: whereHelpernull_String{field: "\"event\".\"deleted_message_uuid\""},
}
...
type eventR struct {
	...
	Recipient    *User         `db:"Recipient" boil:"Recipient" json:"Recipient" toml:"Recipient" yaml:"Recipient"`
}
...
func (o *EventSlice) Uuids() []uuid.UUID {
...
func (o *EventSlice) ConversationIDs() []int {
	ids := map[int]bool{}
	for _, item := range *o {
		if item.ConversationID.Valid {
			ids[item.ConversationID.Int] = true
		}
	}
...
var (
	eventAllColumns            = []string{"id", "uuid", "created_at", "type", "recipient_id", "message_id", "conversation_id", "deleted_message_uuid"}
	eventColumnsWithoutDefault = []string{"type", "recipient_id", "message_id", "conversation_id", "deleted_message_uuid"}
	eventColumnsWithDefault    = []string{"id", "uuid", "created_at"}
...
func (o *Event) Conversation(mods ...qm.QueryMod) conversationQuery {
...
func (o *Event) Message(mods ...qm.QueryMod) messageQuery {
	queryMods := []qm.QueryMod{
...
func (o *Event) Recipient(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
func (eventL) LoadConversation(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
	...
	if singular {
		...
		if !queries.IsNil(object.ConversationID) {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.ConversationID) {
					continue Outer
				}
			}

			if !queries.IsNil(obj.ConversationID) {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.ConversationID, foreign.ID) {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (eventL) LoadMessage(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
	...
	if singular {
		...
		if !queries.IsNil(object.MessageID) {
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if queries.Equal(a, obj.MessageID) {
					continue Outer
				}
			}

			if !queries.IsNil(obj.MessageID) {
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.MessageID, foreign.ID) {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (eventL) LoadRecipient(ctx context.Context, e boil.ContextExecutor, singular bool, maybeEvent interface{}, mods queries.Applicator) error {
	var slice []*Event
	var object *Event
	...
	if singular {
		...
		args = append(args, object.RecipientID)
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if a == obj.RecipientID {
					continue Outer
				}
			}

			args = append(args, obj.RecipientID)
	...
	if singular {
		...
		foreign.R.RecipientEvents = append(foreign.R.RecipientEvents, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.RecipientID == foreign.ID {
				...
				foreign.R.RecipientEvents = append(foreign.R.RecipientEvents, local)
				break
			}
		}
	}
...
// SetConversation of the event to the related item.
// Sets o.R.Conversation to related.
// Adds o to related.R.Events.
func (o *Event) SetConversation(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Conversation) error {
	var err error
	if insert {
	...
	queries.Assign(&o.ConversationID, related.ID)
	if o.R == nil {
		o.R = &eventR{
...
// RemoveConversation relationship.
// Sets o.R.Conversation to nil.
// Removes o from all passed in related items' relationships struct (Optional).
func (o *Event) RemoveConversation(ctx context.Context, exec boil.ContextExecutor, related *Conversation) error {
	var err error

	queries.SetScanner(&o.ConversationID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("conversation_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.Events {
		if queries.Equal(o.ConversationID, ri.ConversationID) {
			continue
		}
...
// SetMessage of the event to the related item.
// Sets o.R.Message to related.
// Adds o to related.R.Events.
func (o *Event) SetMessage(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Message) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	queries.Assign(&o.MessageID, related.ID)
	if o.R == nil {
		o.R = &eventR{
			Message: related,
		}
...
// Removes o from all passed in related items' relationships struct (Optional).
func (o *Event) RemoveMessage(ctx context.Context, exec boil.ContextExecutor, related *Message) error {
	var err error

	queries.SetScanner(&o.MessageID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("message_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}
	...
	for i, ri := range related.R.Events {
		if queries.Equal(o.MessageID, ri.MessageID) {
			continue
		}
...
// SetRecipient of the event to the related item.
// Sets o.R.Recipient to related.
// Adds o to related.R.RecipientEvents.
func (o *Event) SetRecipient(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &userR{
			RecipientEvents: EventSlice{o},
		}
	} else {
		related.R.RecipientEvents = append(related.R.RecipientEvents, o)
	}
...
func (o *Event) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert event")
	}
