...
var WalkTableColumns = struct {
	...
	UUID:        "walk.uuid",
	Title:       "walk.title",
	CoverID:     "walk.cover_id",
	AudioID:     "walk.audio_id",
	AuthorID:    "walk.author_id",
...
type (
	...
	// This should almost always be used instead of []Walk.
	WalkSlice []*Walk
...
func FindWalk(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Walk, error) {
	...
	if err = walkObj.doAfterSelectHooks(ctx, exec); err != nil {
		return walkObj, err
	}
