...
var UserWalkTableColumns = struct {
	ID     string
	UserID string
	WalkID string
}{
	ID:     "user_walk.id",
	UserID: "user_walk.user_id",
	WalkID: "user_walk.walk_id",
}
...
type (
	...
	// This should almost always be used instead of []UserWalk.
...
func FindUserWalk(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UserWalk, error) {
	...
	if err = userWalkObj.doAfterSelectHooks(ctx, exec); err != nil {
		return userWalkObj, err
	}
