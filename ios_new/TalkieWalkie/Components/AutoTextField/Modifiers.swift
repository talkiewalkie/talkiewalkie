...
public extension AutoTextField {
    ...
    func placeholder(_ placeholder: String) -> AutoTextField {
    ...
    ///         }
    func placeholder<V: View>(_ placeholder: String, _ configure: (Text) -> V) -> AutoTextField {
        var view = self
    ...
    func placeholder<V: View>(_ placeholder: V) -> AutoTextField {
        var view = self
    ...
    func autoDetectDataTypes(_ types: UIDataDetectorTypes) -> AutoTextField {
        var view = self
    ...
    func foregroundColor(_ color: UIColor) -> AutoTextField {
        var view = self
    ...
    func autocapitalization(_ style: UITextAutocapitalizationType) -> AutoTextField {
        var view = self
    ...
    func multilineTextAlignment(_ alignment: TextAlignment) -> AutoTextField {
        var view = self
    ...
    func font(_ font: UIFont) -> AutoTextField {
        var view = self
        view.font = font
        return view
    }
    ...
    func fontWeight(_ weight: UIFont.Weight) -> AutoTextField {
    ...
    func clearOnInsertion(_ value: Bool) -> AutoTextField {
        var view = self
    ...
    func disableAutocorrection(_ disable: Bool?) -> AutoTextField {
        var view = self
    ...
    func isEditable(_ isEditable: Bool) -> AutoTextField {
        var view = self
    ...
    func isSelectable(_ isSelectable: Bool) -> AutoTextField {
        var view = self
    ...
    func returnKey(_ style: UIReturnKeyType?) -> AutoTextField {
        var view = self
    ...
    func automaticallyEnablesReturn(_ value: Bool?) -> AutoTextField {
        var view = self
    ...
    func truncationMode(_ mode: Text.TruncationMode) -> AutoTextField {
        var view = self
        switch mode {
