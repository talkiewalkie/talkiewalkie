...
fileprivate func holedMask<ShapeType: Shape>(in frame: CGRect, rect: CGRect, shape: ShapeType) -> Path {
...
extension View {
    public func maskWithHole<ShapeType: Shape>(rect: CGRect, shape: ShapeType) -> some View {
        self.modifier(
