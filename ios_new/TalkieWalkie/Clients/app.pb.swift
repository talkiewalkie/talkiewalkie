...
public struct App_UserGetInput {
    ...
    public var id: App_UserGetInput.OneOf_ID?

    public var handle: String {
        get {
            if case let .handle(v)? = id { return v }
            return String()
        }
    ...
    public var uuid: String {
        get {
            if case let .uuid(v)? = id { return v }
            return String()
        }
        ...
        case uuid(String)
            ...
            public static func == (lhs: App_UserGetInput.OneOf_ID, rhs: App_UserGetInput.OneOf_ID) -> Bool {
                ...
                case (.handle, .handle): return {
                        guard case let .handle(l) = lhs, case let .handle(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.uuid, .uuid): return {
                        guard case let .uuid(l) = lhs, case let .uuid(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
...
public struct App_MessageSendInput {
    ...
    public var recipients: App_MessageSendInput.OneOf_Recipients?

    public var convUuid: String {
        get {
            if case let .convUuid(v)? = recipients { return v }
            return String()
        }
    ...
    public var handles: App_Handles {
        get {
            if case let .handles(v)? = recipients { return v }
            return App_Handles()
        }
        ...
        case handles(App_Handles)
            ...
            public static func == (lhs: App_MessageSendInput.OneOf_Recipients, rhs: App_MessageSendInput.OneOf_Recipients) -> Bool {
                ...
                case (.handles, .handles): return {
                        guard case let .handles(l) = lhs, case let .handles(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                default: return false
                }
...
extension App_User: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !handle.isEmpty {
            try visitor.visitSingularStringField(value: handle, fieldNumber: 1)
        }
        if !uuid.isEmpty {
...
extension App_UserGetInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        switch id {
        case .handle?: try {
                guard case let .handle(v)? = self.id else { preconditionFailure() }
                try visitor.visitSingularStringField(value: v, fieldNumber: 1)
            }()
        case .uuid?: try {
                guard case let .uuid(v)? = self.id else { preconditionFailure() }
...
extension App_Handles: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !handles.isEmpty {
            try visitor.visitRepeatedStringField(value: handles, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension App_MessageSendInput: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try {
                    ...
                    if let current = self.recipients {
                        hadOneofValue = true
                        if case let .handles(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        switch recipients {
        case .convUuid?: try {
                guard case let .convUuid(v)? = self.recipients else { preconditionFailure() }
                try visitor.visitSingularStringField(value: v, fieldNumber: 1)
            }()
        case .handles?: try {
                guard case let .handles(v)? = self.recipients else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
            }()
        case nil: break
        }
        try { if case let .textMessage(v)? = self.content {
            try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
        } }()
        try unknownFields.traverse(visitor: &visitor)
    }
